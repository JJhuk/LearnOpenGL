...
int main()
{
	...
	//��ġ Attribute
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, sizeof(float) * 6, reinterpret_cast<void*>(0)); //���� ��ġ �����ͱ��� stride�� 6 * 4 = 24
	glEnableVertexAttribArray(0);

	//���� Attribute
	glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, sizeof(float) * 6, reinterpret_cast<void*>(3 * sizeof(float))); //������ offset�� ��ġ ������ �����̹Ƿ� 3ĭ��
